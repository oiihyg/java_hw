...
import java_lhh_day18.homeV1.Schedule;
...
public class PostManager implements Program{
	...
	private void search() {
		...
		//게시글을 확인할건지 선택
		System.out.print("게시글을 확인하겠습니까?(y/n)");
	...
	private void delete() {
		...
		*/
		// 2.
		// 삭제를 하면 true 삭제를 못하면 false를 리턴함
		if(list.remove(post)) {
			printBar();
			System.out.println(post.getNum()+"번 게시글이 삭제되었습니다.");
		}
	...
	*/
	/*
	@Override
	public void save11(String fileName) {
